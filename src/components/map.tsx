...
let Medina: FavouritePlaceProps = {
  id: "Medina",
...
let FavouritePlaces: FavouritePlaceProps[] = [Medina, Mecca];
let FavouritePlacesInstance = FavouritePlaces.map(FavouritePlace);

export default FavouritePlacesInstance;
