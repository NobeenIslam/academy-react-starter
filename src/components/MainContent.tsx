...
function MainContent(): JSX.Element {
  const Medina: FavouritePlaceProps = {
    id: "Medina",
  ...
  const Mecca: FavouritePlaceProps = {
    id: "Mecca",
  ...
  const FavouritePlaces: FavouritePlaceProps[] = [Medina, Mecca];
  const FavouritePlacesInstances = FavouritePlaces.map(FavouritePlace);

  return <main>{FavouritePlacesInstances}</main>;
}
